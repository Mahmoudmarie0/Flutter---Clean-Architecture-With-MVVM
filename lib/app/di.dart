...
Future<void> initAppModule() async {
  ...
  instance.registerLazySingleton<SharedPreferences>(() =>
      sharedPrefs); //lazy singleton here means we have only one sharedpref instance in whole app
  ...
  final dio = await dioFactory.getDio(); // Await here to get the Dio instance
